...
internal data class WorkoutClassification(val sharedSystem: String, val value: SourceCodedValue)

private data class WorkoutCoding(val sourceToken: String, val sharedCode: String)
...
private val EXERCISE_TYPES: Map<Int, WorkoutCoding> = mapOf(
    ...
    activity(ExerciseSessionRecord.EXERCISE_TYPE_FOOTBALL_AMERICAN, "EXERCISE_TYPE_FOOTBALL_AMERICAN", "american-football"),
    ...
    activity(ExerciseSessionRecord.EXERCISE_TYPE_STAIR_CLIMBING_MACHINE, "EXERCISE_TYPE_STAIR_CLIMBING_MACHINE", "stair-climbing"),
    activity(ExerciseSessionRecord.EXERCISE_TYPE_STRENGTH_TRAINING, "EXERCISE_TYPE_STRENGTH_TRAINING", "strength-training"),
    ...
    activity(ExerciseSessionRecord.EXERCISE_TYPE_WEIGHTLIFTING, "EXERCISE_TYPE_WEIGHTLIFTING", "strength-training"),
...
private val EXERCISE_SEGMENT_TYPES: Map<Int, WorkoutCoding> = mapOf(
    ...
    segment(ExerciseSegment.EXERCISE_SEGMENT_TYPE_BACK_EXTENSION, "EXERCISE_SEGMENT_TYPE_BACK_EXTENSION", "strength-training"),
    ...
    segment(ExerciseSegment.EXERCISE_SEGMENT_TYPE_BENCH_SIT_UP, "EXERCISE_SEGMENT_TYPE_BENCH_SIT_UP", "strength-training"),
    ...
    segment(ExerciseSegment.EXERCISE_SEGMENT_TYPE_KETTLEBELL_SWING, "EXERCISE_SEGMENT_TYPE_KETTLEBELL_SWING", "strength-training"),
    segment(ExerciseSegment.EXERCISE_SEGMENT_TYPE_LATERAL_RAISE, "EXERCISE_SEGMENT_TYPE_LATERAL_RAISE", "strength-training"),
    segment(ExerciseSegment.EXERCISE_SEGMENT_TYPE_LAT_PULL_DOWN, "EXERCISE_SEGMENT_TYPE_LAT_PULL_DOWN", "strength-training"),
    segment(ExerciseSegment.EXERCISE_SEGMENT_TYPE_LEG_CURL, "EXERCISE_SEGMENT_TYPE_LEG_CURL", "strength-training"),
    segment(ExerciseSegment.EXERCISE_SEGMENT_TYPE_LEG_EXTENSION, "EXERCISE_SEGMENT_TYPE_LEG_EXTENSION", "strength-training"),
    ...
    segment(ExerciseSegment.EXERCISE_SEGMENT_TYPE_SHOULDER_PRESS, "EXERCISE_SEGMENT_TYPE_SHOULDER_PRESS", "strength-training"),
    segment(
    ...
    segment(ExerciseSegment.EXERCISE_SEGMENT_TYPE_SWIMMING_BACKSTROKE, "EXERCISE_SEGMENT_TYPE_SWIMMING_BACKSTROKE", "swimming"),
    segment(ExerciseSegment.EXERCISE_SEGMENT_TYPE_SWIMMING_BREASTSTROKE, "EXERCISE_SEGMENT_TYPE_SWIMMING_BREASTSTROKE", "swimming"),
    segment(ExerciseSegment.EXERCISE_SEGMENT_TYPE_SWIMMING_BUTTERFLY, "EXERCISE_SEGMENT_TYPE_SWIMMING_BUTTERFLY", "swimming"),
    segment(ExerciseSegment.EXERCISE_SEGMENT_TYPE_SWIMMING_FREESTYLE, "EXERCISE_SEGMENT_TYPE_SWIMMING_FREESTYLE", "swimming"),
    segment(ExerciseSegment.EXERCISE_SEGMENT_TYPE_SWIMMING_MIXED, "EXERCISE_SEGMENT_TYPE_SWIMMING_MIXED", "swimming"),
    segment(ExerciseSegment.EXERCISE_SEGMENT_TYPE_SWIMMING_OPEN_WATER, "EXERCISE_SEGMENT_TYPE_SWIMMING_OPEN_WATER", "swimming"),
    ...
    segment(ExerciseSegment.EXERCISE_SEGMENT_TYPE_WEIGHTLIFTING, "EXERCISE_SEGMENT_TYPE_WEIGHTLIFTING", "strength-training"),
...
internal object HealthConnectWorkoutVocabulary {
    ...
    private val segmentDisplays = HealthConnectContextMappings.displays.getValue(HealthConnectContract.GROVE_WORKOUT_SEGMENT_TYPE)

    init {
        check(EXERCISE_TYPES.values.all { it.sourceToken in HealthConnectContextMappings.exerciseType.codes }) {
            "Every absorbed exercise type must be a catalog-admitted source token."
        }
        check(EXERCISE_SEGMENT_TYPES.values.all { it.sourceToken in HealthConnectContextMappings.exerciseSegmentType.codes }) {
            "Every absorbed segment type must be a catalog-admitted source token."
        }
    }

    fun activity(exerciseType: Int): SourceCodedValue = EXERCISE_TYPES[exerciseType]?.coded()
        ?: refuse(HealthConnectValueFailure.UnsupportedSourceValue("ExerciseSessionRecord.exerciseType"))

    fun activityToken(sourceToken: String): Int? = EXERCISE_TYPES.entries.firstOrNull { it.value.sourceToken == sourceToken }?.key

    fun segment(segmentType: Int): WorkoutClassification = EXERCISE_SEGMENT_TYPES[segmentType]
        ?.let { WorkoutClassification(it.sharedSystem(), it.coded()) }
        ?: refuse(HealthConnectValueFailure.UnsupportedSourceValue("ExerciseSegment.segmentType"))

    fun segmentToken(sourceToken: String): Int? =
        EXERCISE_SEGMENT_TYPES.entries.firstOrNull { it.value.sourceToken == sourceToken }?.key

    fun lap(): WorkoutClassification = WorkoutClassification(
        HealthConnectContract.GROVE_WORKOUT_SEGMENT_TYPE,
        SourceCodedValue(LAP_TOKEN, LAP_TOKEN, "Exercise lap", LAP_CODE),
    )

    private fun WorkoutCoding.coded(): SourceCodedValue =
        SourceCodedValue(sourceToken, sourceToken, sourceDisplay(), sharedCode)

    private fun WorkoutCoding.sharedSystem(): String = if (sharedCode in segmentDisplays) {
        HealthConnectContract.GROVE_WORKOUT_SEGMENT_TYPE
    } else {
