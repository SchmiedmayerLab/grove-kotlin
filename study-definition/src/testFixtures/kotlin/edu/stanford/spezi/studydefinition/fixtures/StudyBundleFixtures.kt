...
/**
 * Shared test data for study definitions, backed by an example `.spezistudybundle` on the
...
object StudyBundleFixtures {
    private const val EXAMPLE_BUNDLE_RESOURCE = "fixtures/example.spezistudybundle"
