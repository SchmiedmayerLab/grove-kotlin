 ...
 * of [GroveLogger] which requires it to be visible outside of the component for the inline function to access it.
 * @see [GroveLogger] for the reasoning behind inline functions.
 */
