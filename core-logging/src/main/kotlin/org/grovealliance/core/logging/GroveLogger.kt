...
import org.grovealliance.core.logging.GroveLogger.Companion.tag
 ...
 *
 * @see [groveLogger] and [groupLogger] for configuration options and how to create [GroveLogger] instances.
 *
 */
class GroveLogger internal constructor(private val tag: String, private val config: LoggerConfig) {
     ...
     * @return This [GroveLogger] instance with the next tag set.
     */
    ...
    /**
     * Creates a new [GroveLogger] instance with the specified message prefix.
     *
     * @param prefix The message prefix to be added to log messages.
     * @return A new [GroveLogger] instance with the specified message prefix.
     */
    fun withMessagePrefix(prefix: String): GroveLogger = GroveLogger(
        tag = tag,
    ...
    companion object {
        ...
        /**
         * Logs an informational message with tag `org.grovealliance.logger` using [LoggingStrategy.TIMBER].
         *
         * @param throwable Optional throwable associated with the message.
         * @param message A function providing the message to be logged.
         */
        ...
        /**
         * Logs a warning message with tag `org.grovealliance.logger` using [LoggingStrategy.TIMBER].
         *
         * @param throwable Optional throwable associated with the message.
         * @param message A function providing the message to be logged.
         */
        ...
        /**
         * Logs an error message with tag `org.grovealliance.logger` using [LoggingStrategy.TIMBER].
         *
         * @param throwable Optional throwable associated with the message.
         * @param message A function providing the message to be logged.
         */
