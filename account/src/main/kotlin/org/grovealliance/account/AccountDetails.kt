...
import org.grovealliance.foundation.ComputedKnowledgeSourceType
import org.grovealliance.foundation.DefaultProvidingKnowledgeSourceType
import org.grovealliance.foundation.KnowledgeSourceType
import org.grovealliance.foundation.OptionalComputedKnowledgeSourceType
 ...
 * Please refer to [org.grovealliance.foundation.ValueRepository] and different [KnowledgeSourceType]s
 *
...
class AccountDetails(private val storage: AccountStorage) {
     ...
     *
     * Behavior is defined by [org.grovealliance.foundation.DefaultProvidingKnowledgeSource] for how the key is expected to be defined
     ...
     *
     * Behavior is defined by [org.grovealliance.foundation.ComputedKnowledgeSource] for how the key is expected to be defined
     ...
     *
     * Behavior is defined by [org.grovealliance.foundation.OptionalComputedKnowledgeSource] for how the key is expected to be defined
     * (object or companion object implementation) and how caching is controlled via the storage policy.
     *
