...
import org.grovealliance.account.internal.AccountDetailsCodec
import org.grovealliance.account.internal.StoredAccountDetails
...
class AccountDetailsCache : Module {
    ...
    private fun storageKey(accountId: String): String {
        return "org.grovealliance.account.firebase.storage.$accountId"
    }
}
