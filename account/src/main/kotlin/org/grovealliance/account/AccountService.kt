...
/**
 * The main interface for managing user accounts within the Grove framework.
 *
...
interface AccountService : Module {
    /**
     * The configuration for this [AccountService], as defined in the Grove configuration.
     */
