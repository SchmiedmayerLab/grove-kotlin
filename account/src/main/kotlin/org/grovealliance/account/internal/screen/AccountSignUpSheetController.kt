...
import org.grovealliance.account.AccountIdKey
...
import org.grovealliance.account.AnyAccountKeyType
...
import org.grovealliance.account.instance
import org.grovealliance.account.isAnonymousUser
import org.grovealliance.account.keys
import org.grovealliance.account.requiredAccountKeys
...
import org.grovealliance.ui.account.SignUpFormEntry
import org.grovealliance.ui.account.SignUpFormLayout
import org.grovealliance.ui.account.SignUpSection
...
internal class AccountSignUpSheetController(
    ...
    private suspend fun submitSignUpForm(scaffoldState: MutableGroveScaffoldState, onEvent: (AccountSheetEvent) -> Unit) {
