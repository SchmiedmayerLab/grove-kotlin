...
private class PreviewParams : PreviewParameterProvider<GroveInputField> {
    private val base = GroveInputField(
        value = "your.email@stanford.edu",
        placeholder = StringResource("Enter value"),
        onValueChanged = {},
    )

    override val values: Sequence<GroveInputField> = sequenceOf(
        base,
        base.copy(
...
@ThemePreviews
@Composable
private fun Preview(@PreviewParameter(PreviewParams::class) input: GroveInputField) {
    GroveTheme {
