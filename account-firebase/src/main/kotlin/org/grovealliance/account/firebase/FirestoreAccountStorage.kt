...
import org.grovealliance.account.AccountDetailsCache
...
import org.grovealliance.account.firebase.internal.FirestoreAccountDetailsCodec
 ...
 *
 * A Firestore document is created per `accountId`, where each stored [org.grovealliance.account.AccountKey]
