...
import edu.stanford.spezi.scheduler.TaskStorageKey
...
object StudyContextKey : TaskStorageKey<StudyContext> {
    override val identifier: String = "edu.stanford.spezi.study.studyContext"
...
object ScheduledTaskActionKey : TaskStorageKey<ScheduledTaskAction> {
    override val identifier: String = "edu.stanford.spezi.study.scheduledTaskAction"
...
object StudyTaskCategories {
     ...
     */
    val informational = TaskCategory("edu.stanford.spezi.SpeziStudy.task.informational")

    /**
     * A timed walking test task.
     */
    val timedWalkingTest = TaskCategory("edu.stanford.spezi.SpeziStudy.task.timedWalkingTest")

    /**
     * A timed running test task.
     */
    val timedRunningTest = TaskCategory("edu.stanford.spezi.SpeziStudy.task.timedRunningTest")
    ...
    fun customActiveTask(identifier: String) =
        TaskCategory("edu.stanford.spezi.SpeziStudy.task.customActiveTask:$identifier")
}
...
object StudyTaskId {
     ...
     */
    const val PREFIX = "edu.stanford.spezi.SpeziStudy.studyComponentTask."
