 ...
 * [org.grovealliance.core.ConfigurationBuilder].
 *
 ...
 *   Used for both [Module] and [org.grovealliance.core.ConfigurationBuilder.singleton] registrations.
 * - **Transient factories** – evaluated on every [resolveDependency] call, never cached.
 *   Used for [org.grovealliance.core.ConfigurationBuilder.factory] registrations.
 *
...
internal class DependencyRegistry {
     ...
     * Covers [Module] registrations and [org.grovealliance.core.ConfigurationBuilder.singleton].
     */
     ...
     * Covers [org.grovealliance.core.ConfigurationBuilder.factory] registrations.
     */
