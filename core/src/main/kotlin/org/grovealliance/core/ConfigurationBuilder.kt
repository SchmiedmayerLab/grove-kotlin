...
/**
 * Builder for creating a [Configuration] for a [GroveApplication].
 */
@GroveDsl
class ConfigurationBuilder internal constructor(private val standard: Standard) {
    ...
    /**
     * Registers a singleton dependency of type [T] in the Grove dependency graph.
     *
    ...
    /**
     * Registers a transient factory for type [T] in the Grove dependency graph.
     *
